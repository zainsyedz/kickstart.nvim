return {
  ...
  config = function()
    ...
    --
    local function load_project_specific_settings(server_name)
      local project_settings_file = vim.fn.getcwd() .. '/.lspconfig/' .. server_name .. '.lua'
      if vim.fn.filereadable(project_settings_file) == 1 then
        return dofile(project_settings_file)
      end
      return {}
    end
